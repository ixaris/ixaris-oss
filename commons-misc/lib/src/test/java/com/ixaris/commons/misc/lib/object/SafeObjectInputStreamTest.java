...
public class SafeObjectInputStreamTest {
    ...
    public void deserializeAllowedType_ShouldBeReadCorrectly() throws Exception {
        ...
        assertEquals(original, deserialized, "Object should be read back correctly");
    }
    ...
    public void deserializeIllegalType_ShouldThrowException() {
        ...
        assertThrows(InvalidClassException.class, () ->
            serializeAndDeserialize(original, in -> createSafeInputStream(in))
        );
    }
    ...
    private static <T> T serializeAndDeserialize(
        final T t, final Function<InputStream, SafeObjectInputStream> inputStreamSupplier
