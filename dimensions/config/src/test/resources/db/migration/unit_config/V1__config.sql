CREATE TABLE lib_dim_config_value (
    id BIGINT NOT NULL,
    value_key VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
...
CREATE TABLE lib_dim_config_set (
    id BIGINT NOT NULL,
    set_key VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
    context_depth BIGINT NOT NULL,
    PRIMARY KEY (id),
...
CREATE TABLE lib_dim_config_set_value (
    ...
    UNIQUE KEY ux_lib_dim_config_set_value__long_value_string_value_id (long_value, string_value, id)
) DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED;
