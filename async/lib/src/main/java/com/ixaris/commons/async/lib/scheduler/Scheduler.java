...
public interface Scheduler {
     ...
     * @return the scheduled task which can be used to cancel the schedule
     */
    ScheduledFuture<Void> scheduleAtFixedRate(final Runnable runnable, final long initialDelay, final long period, final TimeUnit unit);
     ...
     * @return the scheduled task which can be used to cancel the schedule
     */
    ScheduledFuture<Void> scheduleWithFixedDelay(final Runnable runnable, final long initialDelay, final long delay, final TimeUnit unit);
