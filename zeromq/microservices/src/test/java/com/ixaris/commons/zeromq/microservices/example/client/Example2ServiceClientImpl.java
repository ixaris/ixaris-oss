...
import com.ixaris.commons.zeromq.microservices.example2.client.Example2Stub;

public final class Example2ServiceClientImpl {
    
    private final Example2Stub exampleResource;
    
    public Example2ServiceClientImpl(final Example2Stub exampleResource) {
    ...
    public void benchmark(final int count) {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            final Async<ExampleResponse> p = exampleResource.op(header, ExampleRequest.newBuilder().build());
            try {
                block(p);
            } catch (Throwable e) {
                e.printStackTrace();
        ...
        for (int i = 0; i < count; i++) {
            ...
            final Async<ExampleResponse> p = exampleResource.op(context, ExampleRequest.newBuilder().build());
            try {
                block(p);
            } catch (Throwable e) {
                e.printStackTrace();
