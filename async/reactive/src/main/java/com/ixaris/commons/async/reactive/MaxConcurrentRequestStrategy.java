...
/**
 * A request strategy that allows a maximum of concurrent messages. Requests 1 message for every completed message. Users of this class should
 * make sure that finishMessage is called when a message finishes processing, otherwise the requests may become exhausted.
 *
 * @author brian.vella
 */
