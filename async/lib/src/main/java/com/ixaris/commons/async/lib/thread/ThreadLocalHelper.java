...
public class ThreadLocalHelper {
    ...
    public static <T, V, E extends Exception> Async<V> exec(final ThreadLocal<T> threadLocal, final T value, final CompletionStageCallableThrows<V, E> task) throws E {
        if (threadLocal == null) {
            throw new IllegalArgumentException("threadLocal is null");
        }
        if (task == null) {
