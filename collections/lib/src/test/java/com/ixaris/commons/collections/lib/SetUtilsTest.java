...
public class SetUtilsTest {
    ...
    public void testCombinationsSizeZero() {
        assertTrue(SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3, 4, 5).build(), 0).isEmpty());
    }
    ...
    public void testCombinationsSizeOne() {
        final Set<Set<Integer>> combinations = SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3).build(), 1);
        assertEquals(SetBuilder
            .with(new HashSet<Set<Integer>>())
            .add(SetBuilder.with(new HashSet<Integer>()).add(1).build(),
    ...
    public void testCombinations_ThreeElements_SizeTwo() {
        final Set<Set<Integer>> combinations = SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3).build(), 2);
        assertEquals(SetBuilder
            .with(new HashSet<Set<Integer>>())
            .add(SetBuilder.with(new HashSet<Integer>()).add(1, 2).build(),
    ...
    public void testCombinations_FourElements_SizeTwo() {
        final Set<Set<Integer>> combinations = SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3, 4).build(), 2);
        assertEquals(SetBuilder
            .with(new HashSet<Set<Integer>>())
            .add(SetBuilder.with(new HashSet<Integer>()).add(1, 2).build(),
                SetBuilder.with(new HashSet<Integer>()).add(1, 3).build(),
    ...
    public void testCombinations_ThreeElements_SizeThree() {
        final Set<Set<Integer>> combinations = SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3).build(), 3);
        assertEquals(SetBuilder.with(new HashSet<Set<Integer>>()).add(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3).build()).build(),
            combinations);
    }
    ...
    public void testCombinations_FourElements_SizeThree() {
        final Set<Set<Integer>> combinations = SetUtils.combinations(SetBuilder.with(new HashSet<Integer>()).add(1, 2, 3, 4).build(), 3);
        assertEquals(SetBuilder
            .with(new HashSet<Set<Integer>>())
