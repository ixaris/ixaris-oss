...
import com.ixaris.commons.microservices.defaults.app.example.client.ExampleStub;
import com.ixaris.commons.microservices.defaults.app.example2.resource.Example2Resource;
 ...
 */
@Service
public class Example2ResourceSpringImpl implements Example2Resource, Example2Skeleton {
    ...
    @Autowired
    public Example2ResourceSpringImpl(final Example2Skeleton.Watch publisher, final ExampleStub example) {
