...
/**
 * DO NOT USE FOR SENSITIVE INFORMATION. Currently used for reading/writing encrypted file values (or things like password to the SSM, which
 * obviously cannot be encrypted by the SSM). Created by tiago.cucki on 24/11/2016.
 */
public class ConfEncrypt {
    ...
    private static final byte[] KEY = "AZAZB3NzaC1kc3MAAACBAKv0stHlfMsx".getBytes(StandardCharsets.UTF_8);
    ...
    /**
     * DO NOT USE FOR SENSITIVE INFORMATION. Currently used for reading/writing encrypted file values (or things like password to the SSM, which
     * obviously cannot be encrypted by the SSM).
     *
