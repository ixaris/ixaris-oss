...
public class SnakeCaseHelperTest {
    ...
    public void snakeToCamel() {
        ...
        Assertions.assertThat(SnakeCaseHelper.snakeToCamelCase("some_other_word_with_many_parts")).isEqualTo("someOtherWordWithManyParts");
    ...
    public void camelToSnake() {
        ...
        Assertions.assertThat(SnakeCaseHelper.camelToSnakeCase("someOtherWordWithManyParts")).isEqualTo("some_other_word_with_many_parts");
