...
public class MessageHelperTest {
    ...
    public void testFingerprint() {
        ...
        final FingerprintMessage m2 = FingerprintMessage.newBuilder()
            .setS("")
            .setNested(Nested.newBuilder().setE(E.DEFAULT).build())
            .build();
    ...
    public void protobufToJsonConversion_NoDefaultFields_AllFieldsSerialized() {
        ...
        final String
        expectedJson = "{\"boolean\":true,\"string\":\"test\",\"integer\":42,\"long\":\"43\",\"enum\":\"ONE\",\"nested\":{\"a\":\"\",\"b\":\"\",\"c\":56,\"d\":\"1024\",\"e\":\"A\"}}";
    ...
    public void protobufToJsonConversion_AllDefaultFields_AllFieldsSerializedWithDefaultValues() {
        ...
        final String
        expectedJson = "{\"boolean\":false,\"string\":\"\",\"integer\":0,\"long\":\"0\",\"enum\":\"ZERO\"}";
    ...
    @Test
    public void
    jsonToProtobufConversion_ValidMessageAsJson_RespectiveProtobufMessageReturned() throws InvalidProtocolBufferException {
        final String
        json = "{\"boolean\":true,\"string\":\"test\",\"integer\":42,\"long\":\"43\",\"enum\":\"ONE\",\"nested\":{\"c\":56,\"d\":\"1024\",\"e\":\"A\"}}";
        ...
        Assertions
            .assertThat(MessageHelper.parse(ExampleMessage.getDefaultInstance(), json))
            .isEqualTo(expectedMessage);
    }
    
    @Test
    public void
    jsonToProtobufConversion_EmptyJsonMessage_DefaultProtobufMessageReturned() throws InvalidProtocolBufferException {
        final String json = "{}";
