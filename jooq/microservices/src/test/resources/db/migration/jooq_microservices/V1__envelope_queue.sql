CREATE TABLE lib_publish_event_queue (
    ...
    KEY ix_lib_publish_event_queue__shard_path (shard, path),
    KEY ix_lib_publish_event_queue__next_retry_time (next_retry_time)
