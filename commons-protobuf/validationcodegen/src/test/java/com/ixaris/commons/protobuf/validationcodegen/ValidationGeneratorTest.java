...
public class ValidationGeneratorTest {
    ...
    public void generateSingleMessageValidation_validationsWithComplexRegex_generatedCorrectly() {
        ...
        ValidationGenerator.extractFieldValidationInfoAndDependencies(
            "com.ixaris.commons.protobuf.test",
            "str",
            false,
            false,
            JavaType.STRING,
    ...
    public void generateSingleMessageValidation_validations_generatedCorrectly() {
        ...
        Assertions
            ...
            .isEqualTo(
                "v.mapEnumEnum(\"str_map\", com.ixaris.core.nested.ExampleNested.Nested.E.class, m.getStrMapMap()).size(2, 5).entries((k, i) -> { i.required(); })"
            );
        Assertions
            .assertThat(messageKeyEnums.get(0))
            .isEqualTo(
                "case \"str_map\": return getDescriptorForType(com.ixaris.core.nested.ExampleNested.Nested.E.class)"
            );
    }
}
