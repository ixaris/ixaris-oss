...
public class Tuple5<T1, T2, T3, T4, T5> implements Serializable {
    ...
    public final T5 get5() {
        return t5;
    }
    
    @Override
    public boolean equals(final Object o) {
        return EqualsUtil.equals(this,
            o,
            other -> Objects.equals(this.t1, other.t1) && Objects.equals(this.t2, other.t2) && Objects.equals(this.t3, other.t3)
                && Objects.equals(this.t4, other.t4) && Objects.equals(this.t5, other.t5));
    }
    ...
    public String toString() {
        return ToStringUtil.of(this).with("1", t1).with("2", t2).with("3", t3).with("4", t4).with("5", t5).toString();
    }
}
