 ...
 *
 * <p>E.g. can have a strategy that allows x messages per period of time, where one would (internally in the strategy) schedule invoking the
 * request callable repeatedly
 *
 * @author brian.vella
 */
