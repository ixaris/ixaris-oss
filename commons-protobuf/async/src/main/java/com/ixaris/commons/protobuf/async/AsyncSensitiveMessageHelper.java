...
public final class AsyncSensitiveMessageHelper {
     ...
     */
    public static Async<Builder> mapSensitiveFields(
    ...
    public static Async<Builder> mapSensitiveFields(
        ...
        return all(temporaryDataFuture, permanentDataFuture, maskedDataFuture).map(results ->
            applyMappers(builder, sensitiveDataCollection, results.get1(), results.get2(), results.get3())
        );
    }
