 ...
 */
public final class SwaggerOperationDescriptor {
    ...
    SwaggerOperationDescriptor(final String description,
        ...
        this.pathParams = new LinkedList<>(pathParams);
    ...
    public String toString() {
        return "SwaggerOperationDescriptor{"
            + "operationId='"
            + operationId
            + '\''
            + ", httpPath='"
